...
/*const testVirtualNetwork = new azure.network.VirtualNetwork("vNetNikhil",
    {
       addressSpaces: ["30.0.0.0/16"],
       location: resourceGroup.location,
      // name: vNetName,
       resourceGroupName: resourceGroup.name,
       subnets: [
           {
               addressPrefix: "30.0.1.0/24",
               name: "subname1",
              // securityGroup: nsgID1,
           },
           {
               addressPrefix: "30.0.2.0/24",
               name: "subname2",
               //securityGroup: nsgID2,
           },
           {
               addressPrefix: "30.0.3.0/24",
               name: "subname3",
               //securityGroup: nsgID3,
           },
           {
               addressPrefix: "30.0.4.0/24",
               name: "subname4",
           },
       ],
